...
[Windows用EXE](../Lumina-Live.exe)と[単一HTML](../web/Lumina-Live.html)を生成済みです。[GitHub](https://github.com/sakadosoutan-boop/lumina-live)は公開リポジトリです。外部動画はローカルの `assets` に保存しています。
